   ...
   */
       ...
       const miniAct = (ele, seq, call)=>{ 
        ...
        /*
            ...
            - 마지막에 display:none처리!
            [ slideDown(시간,이징,함수) ]
            - display를 보이게 한 후 높이값이 원래값으로 복원애니메이션
        */
       ...
       .next().click((e)=>{
        ...
        // miniAct(버튼자신, 이동할li순번,콜백함수)
       }) /////////// 3-5. "무서우니 위층으로" 버튼 클릭시 끝 ////////////

        // 3-6. "치료주사 방으로" 버튼 클릭시 시작
       // next() 선택요소의 다음 형제요소
       // 앞의 버튼 다음버튼임!
       .next().click((e)=>{
        // 콜백함수 : 이동 후 실행함수 //
